...
<script class="next-config" data-name="main" type="application/json">{"hostname":"jqz3.tech","root":"/","images":"/images","scheme":"Gemini","darkmode":false,"version":"8.10.0","exturl":false,"sidebar":{"position":"left","display":"post","padding":18,"offset":12},"copycode":true,"bookmark":{"enable":false,"color":"#222","save":"auto"},"mediumzoom":false,"lazyload":false,"pangu":false,"comments":{"style":"tabs","active":"utterances","storage":true,"lazyload":false,"nav":null,"activeClass":"utterances"},"stickytabs":false,"motion":{"enable":true,"async":false,"transition":{"post_block":"fadeIn","post_header":"fadeInDown","post_body":"fadeInDown","coll_header":"fadeInLeft","sidebar":"fadeInUp"}},"prism":true,"i18n":{"placeholder":"搜索...","empty":"没有找到任何搜索结果：${query}","hits_time":"找到 ${hits} 个搜索结果（用时 ${time} 毫秒）","hits":"找到 ${hits} 个搜索结果"},"path":"/search.xml","localsearch":{"enable":true,"trigger":"auto","top_n_per_article":1,"unescape":false,"preload":false}}</script><script src="/js/config.js"></script>
    ...
    <meta name="description" content="原环境下# 创建一个临时文件夹并 cd 至该文件夹 mkdir temp &amp;&amp; cd temp # 将当前环境下安装的包写入 requirements.txt pip3 freeze &gt; requirements.txt # 将 requirements.txt 中的包下载到当前文件夹（即创建的临时文件夹） pip3 download -r requirements.txt">
<meta property="og:type" content="article">
<meta property="og:title" content="迁移 Python site-packages">
<meta property="og:url" content="https://jqz3.tech/2022/05/27/transfer-python-site-packages/index.html">
<meta property="og:site_name" content="JQ♡TECH">
<meta property="og:description" content="原环境下# 创建一个临时文件夹并 cd 至该文件夹 mkdir temp &amp;&amp; cd temp # 将当前环境下安装的包写入 requirements.txt pip3 freeze &gt; requirements.txt # 将 requirements.txt 中的包下载到当前文件夹（即创建的临时文件夹） pip3 download -r requirements.txt">
<meta property="og:locale" content="zh_CN">
<meta property="article:published_time" content="2022-05-27T05:20:19.000Z">
<meta property="article:modified_time" content="2022-05-27T05:20:19.000Z">
<meta property="article:author" content="ZJQ">
<meta property="article:tag" content="python">
<meta name="twitter:card" content="summary">


<link rel="canonical" href="https://jqz3.tech/2022/05/27/transfer-python-site-packages/">



<script class="next-config" data-name="page" type="application/json">{"sidebar":"","isHome":false,"isPost":true,"lang":"zh-CN","comments":true,"permalink":"https://jqz3.tech/2022/05/27/transfer-python-site-packages/","path":"2022/05/27/transfer-python-site-packages/","title":"迁移 Python site-packages"}</script>

<script class="next-config" data-name="calendar" type="application/json">""</script>
<title>迁移 Python site-packages | JQ♡TECH</title>
    ...
    <div class="sidebar-inner sidebar-nav-active sidebar-toc-active">
      ...
      <div class="sidebar-panel-container">
        ...
        <div class="post-toc-wrap sidebar-panel">
            <div class="post-toc animated"><ol class="nav"><li class="nav-item nav-level-3"><a class="nav-link" href="#%E5%8E%9F%E7%8E%AF%E5%A2%83%E4%B8%8B"><span class="nav-number">1.</span> <span class="nav-text">原环境下</span></a></li><li class="nav-item nav-level-3"><a class="nav-link" href="#%E8%BF%81%E7%A7%BB%E7%8E%AF%E5%A2%83%E4%B8%8B"><span class="nav-number">2.</span> <span class="nav-text">迁移环境下</span></a></li></ol></div>
        </div>
        <!--/noindex-->
...
<div class="post-block">
  ...
  <article itemscope itemtype="http://schema.org/Article" class="post-content" lang="zh-CN">
    <link itemprop="mainEntityOfPage" href="https://jqz3.tech/2022/05/27/transfer-python-site-packages/">
    ...
    <span hidden itemprop="post" itemscope itemtype="http://schema.org/CreativeWork">
      <meta itemprop="name" content="迁移 Python site-packages | JQ♡TECH">
      <meta itemprop="description" content="">
    </span>
      <header class="post-header">
        <h1 class="post-title" itemprop="name headline">
          迁移 Python site-packages<a href="https://github.com/coder-zjq/BlogSource/edit/master/source/_posts/transfer-python-site-packages.md" class="post-edit-link" title="编辑" rel="noopener" target="_blank"><i class="fa fa-pen-nib"></i></a>
        </h1>
    ...
    <span class="post-meta-item">
      ...
      <time title="创建时间：2022-05-27 13:20:19" itemprop="dateCreated datePublished" datetime="2022-05-27T13:20:19+08:00">2022-05-27</time>
    </span>

  
    <span id="/2022/05/27/transfer-python-site-packages/" class="post-meta-item leancloud_visitors" data-flag-title="迁移 Python site-packages" title="阅读次数">
      <span class="post-meta-item-icon">
    ...
    <div class="post-body" itemprop="articleBody">
        <h3 id="原环境下"><a href="#原环境下" class="headerlink" title="原环境下"></a>原环境下</h3><pre class="line-numbers language-bash" data-language="bash"><code class="language-bash"># 创建一个临时文件夹并 cd 至该文件夹
mkdir temp &amp;&amp; cd temp
...
<ul>
  ...
  <li class="post-copyright-link">
      <strong>本文链接：</strong>
      <a href="https://jqz3.tech/2022/05/27/transfer-python-site-packages/" title="迁移 Python site-packages">https://jqz3.tech/2022/05/27/transfer-python-site-packages/</a>
  </li>
    ...
    <strong>版权声明： </strong>本博客所有文章除特别声明外，均采用 <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/" rel="noopener" target="_blank"><i class="fab fa-fw fa-creative-commons"></i>BY-NC-SA</a> 许可协议。转载请注明出处！
          ...
          <div class="post-nav">
            <div class="post-nav-item">
                <a href="/2022/03/17/macos-update-issue/" rel="prev" title="记录一次 macOS 更新问题">
                  <i class="fa fa-chevron-left"></i> 记录一次 macOS 更新问题
                </a>
            </div>
            <div class="post-nav-item">
                <a href="/2022/06/15/mac2go/" rel="next" title="分享一种安装体验 beta 版 macOS 的方式">
                  分享一种安装体验 beta 版 macOS 的方式 <i class="fa fa-chevron-right"></i>
                </a>
            </div>
          </div>
    </footer>
...
<script src="/js/third-party/search/local-search.js"></script>
  ...
  <script class="next-config" data-name="leancloud_visitors" type="application/json">{"enable":true,"app_id":"NDR4ht5tQMwY98BfVRpuVxev-gzGzoHsz","app_key":"t8QAyw6QhVkCuOx3FUpHNehq","server_url":"https://ndr4ht5t.lc-cn-n1-shared.com","security":true}</script>
